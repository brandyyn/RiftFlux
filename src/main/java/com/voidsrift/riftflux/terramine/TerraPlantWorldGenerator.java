...
public class TerraPlantWorldGenerator implements IWorldGenerator {
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world,
        ...
        generateSurfacePlants(world, random, originX, originZ, TerrariaContent.daybloomBlock, positiveAttempts(ModConfig.daybloomSpawnAttempts));
        generateSurfacePlants(world, random, originX, originZ, TerrariaContent.terraMushroomBlock, positiveAttempts(ModConfig.terraMushroomSpawnAttempts));

        generateUndergroundPlants(world, random, originX, originZ, TerrariaContent.blinkrootBlock, positiveAttempts(ModConfig.blinkrootSpawnAttempts), false);
        generateUndergroundPlants(world, random, originX, originZ, TerrariaContent.waterleafBlock, positiveAttempts(ModConfig.waterleafSpawnAttempts), false);
        generateUndergroundPlants(world, random, originX, originZ, TerrariaContent.deathweedBlock, positiveAttempts(ModConfig.deathweedSpawnAttempts), false);
        generateUndergroundPlants(world, random, originX, originZ, TerrariaContent.fireblossomBlock, positiveAttempts(ModConfig.fireblossomSpawnAttempts), false);

        generateUndergroundPlants(world, random, originX, originZ, TerrariaContent.jungleSporeBlock, positiveAttempts(ModConfig.jungleSporeSpawnAttempts), true);
        generateUndergroundPlants(world, random, originX, originZ, TerrariaContent.moonglowBlock, positiveAttempts(ModConfig.moonglowSpawnAttempts), true);
    }
    ...
    private static int positiveAttempts(int attempts) {
