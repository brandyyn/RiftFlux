...
public class BlockBedsideCabinet extends BlockContainer {
    ...
    public int getRenderType() {
        return FurnitureRenderIds.bedsideCabinetRenderId;
    }
    ...
    public void breakBlock(World world, int x, int y, int z, Block block, int metadata) {
        if (!world.isRemote) {
            ...
            if (tileEntity instanceof TileEntityBedsideCabinet) {
                FurnitureInventoryHelper.dropInventory(world, x, y, z, (TileEntityBedsideCabinet) tileEntity, this.random);
            }
        }
    ...
    public boolean onBlockActivated(World world,
        ...
        if (!world.isRemote) {
            player.openGui(riftflux.instance, FurnitureGuiIds.BEDSIDE_CABINET, world, x, y, z);
        }
        return true;
    }
    ...
    public void registerBlockIcons(IIconRegister register) {
        this.blockIcon = register.registerIcon("riftflux:furniture_bedside_cabinet");
    }
}
