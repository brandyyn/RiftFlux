...
public final class WorldTooltip {
    ...
    public void render(Minecraft mc, float partialTicks) {
        ...
        try {
            ...
            drawTooltipText(mc.fontRenderer, drawX, drawY, alphaBits);
        } finally {
            GL11.glPopMatrix();
            GL11.glPopAttrib();
        }
    ...
    private void drawTooltipText(FontRenderer fontRenderer, int drawX, int drawY, int alphaBits) {
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        for (int i = 0; i < size(); i++) {
            String line = getLine(i);
            if (i == 0) {
                line = rarityFormatting + line;
            }
    ...
    private static void drawTooltipBackground(int x, int y, int width, int height, int colorPrimary, int colorOutline, int colorSecondary) {
    ...
    private static void drawGradientRect(int x, int y, int width, int height, int colorTop, int colorBottom) {
        int right = x + width;
        int bottom = y + height;
