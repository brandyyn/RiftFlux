...
public class GuiInventoryGluttonyCharm extends GuiContainer implements IDefaultGui {
   protected boolean boundDefaultTexture;
   private int[] edges;

   public GuiInventoryGluttonyCharm(EntityPlayer player) {
      super(new ContainerGluttonyCharm(player));
   }
   ...
   protected void drawGuiContainerForegroundLayer(int par1, int par2) {
      String text = I18n.format("Gluttony Charm", new Object[0]);
   ...
   protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
      ...
      RenderHelper.drawDefaultSlot(this, 0, -57);
