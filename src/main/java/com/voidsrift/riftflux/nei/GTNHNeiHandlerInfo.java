...
public final class GTNHNeiHandlerInfo {
    ...
    public static void register() {
        ...
        try {
            ...
            tag.setString("modId", "riftflux");
            tag.setBoolean("modRequired", true);

            tag.setString("itemName", "riftflux:clayman_doll");
            ...
            info.setString("filter", "riftflux:clayman_doll");
            ...
            pages.appendTag(new NBTTagString("Upgrades and Abilities\n" +
                    ...
                    "\n" +
                    "Emerald: 5-45 uses, deals 3-4 unavoidable lightning damage at medium range, plus two with sugarcane boost, doubles if target is wet (emerald gives 5, emerald block gives 45)\n" +
                    "\n" +
                    ...
                    "\n" +
                    "Glowstone: makes soldier glow, permanently\n" +
                    "\n" +
