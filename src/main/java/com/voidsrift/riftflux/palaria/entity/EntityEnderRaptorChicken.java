...
public class EntityEnderRaptorChicken extends EntityAbstractRaptorChicken implements IEntitySyncData {
    private int teleportDelay;
    private int stareTimer;
    private boolean screaming;

    public EntityEnderRaptorChicken(World world) {
        super(world);
    }
    ...
    protected void applyEntityAttributes() {
        ...
        getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(ModConfig.palariaEnderRaptorChickenMaxHealth);
    ...
    public void onLivingUpdate() {
        ...
        for (int i = 0; i < 2; ++i) {
            worldObj.spawnParticle("portal", posX + (rand.nextDouble() - 0.5D) * (double) width,
        ...
        if (!worldObj.isRemote && isEntityAlive()) {
            if (entityToAttack != null) {
                if (entityToAttack instanceof EntityPlayer && shouldAttackPlayer((EntityPlayer) entityToAttack)) {
                    ...
                    if (entityToAttack.getDistanceSqToEntity(this) < 0.0D) {
                        teleportRandomly();
                    }
                    teleportDelay = 0;
    ...
    protected String getLivingSound() {
        return "riftflux:palaria_ender_raptor_chicken_say";
    }

    @Override
    protected String getHurtSound() {
        return "riftflux:palaria_ender_raptor_chicken_hurt";
    }
    ...
    protected void dropFewItems(boolean recentlyHit, int looting) {
        PalariaMobDrops.dropRange(this, PalariaMobContent.endermiteShard, 1, 3 + looting);
        PalariaMobDrops.dropChance(this, PalariaMobContent.raptorClaw, 0.05F, 1);
        PalariaMobDrops.dropChance(this, Items.ender_pearl, 0.15F, 1);
    }
