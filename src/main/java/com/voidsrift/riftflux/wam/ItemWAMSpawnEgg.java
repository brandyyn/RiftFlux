...
public class ItemWAMSpawnEgg extends Item {
    private final String mobKey;
    private final int primaryColor;
    private final int secondaryColor;

    public ItemWAMSpawnEgg(String mobKey, int primaryColor, int secondaryColor) {
        this.mobKey = mobKey;
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z,
        ...
        EntityLiving mob = WAMMobFactory.createMobByKey(world, mobKey);
        if (mob == null) {
            return false;
        }
