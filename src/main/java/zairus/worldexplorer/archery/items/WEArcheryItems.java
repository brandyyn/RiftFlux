...
public class WEArcheryItems {
    ...
    public static void init() {
        ...
        pebble = new WEItem().setUnlocalizedName("pebble").setTextureName("worldexplorer:pebble").setCreativeTab(WorldExplorer.tabWorldExplorer).setMaxStackSize(16);
        quiver = new Quiver().setCreativeTab(null);
        longbow_handle = new WEItem().setUnlocalizedName("longbow_handle").setTextureName("worldexplorer:longbow_handle_standby").setCreativeTab(WorldExplorer.tabWorldExplorer);
        longbow_string = new WEItem().setUnlocalizedName("longbow_string").setTextureName("worldexplorer:longbow_string_pulling_0").setCreativeTab(WorldExplorer.tabWorldExplorer);
