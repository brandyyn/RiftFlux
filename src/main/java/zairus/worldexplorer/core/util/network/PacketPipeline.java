...
extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket> {
    ...
    public void initalise() {
        this.channels = NetworkRegistry.INSTANCE.newChannel("ZairusWE", new ChannelHandler[]{this});
        this.registerPackets();
    }

    public void registerPackets() {
        this.registerPacket(JournalPacket.class);
        this.registerPacket(GUIEquipmentPacket.class);
    }
