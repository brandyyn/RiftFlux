...
implements IRecipe {
    ...
    public boolean matches(InventoryCrafting invCrafting, World world) {
        ...
        ItemStack[] pattern = new ItemStack[]{null, typeItem, typeItem, this.p_soulSand, this.p_soulSand, typeItem};
    ...
    public ItemStack getCraftingResult(InventoryCrafting invCrafting) {
        for (EnumTurtleType type : EnumTurtleType.VALUES) {
            if (!SAPUtils.areStacksEqualWithWCV(type.item, invCrafting.getStackInSlot(5))) continue;
