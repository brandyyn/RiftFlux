...
extends CommonProxy {
    ...
    public void modInit() {
        ...
        ClaySoldiersMod.EVENT_BUS.register((Object)new SoldierRightHandRenderHandler());
        ClaySoldiersMod.EVENT_BUS.register((Object)new SoldierLeftHandRenderHandler());
        ClaySoldiersMod.EVENT_BUS.register((Object)new SoldierModelRenderHandler());
        ClaySoldiersMod.EVENT_BUS.register((Object)new SoldierBodyRenderHandler());
        ClientRegistry.bindTileEntitySpecialRenderer(TileEntityClayNexus.class, (TileEntitySpecialRenderer)new RenderClayNexus());
        MinecraftForgeClient.registerItemRenderer((Item)Item.getItemFromBlock(RegistryBlocks.clayNexus), (IItemRenderer)new ItemRendererClayNexus());
        MinecraftForge.EVENT_BUS.register((Object)new RenderStatDisplayOverlay());
        MinecraftForge.EVENT_BUS.register((Object)new WorldOnLastRenderHandler());
        MinecraftForge.EVENT_BUS.register((Object)new Textures());
        RenderClayCamHandler clayCamHandler = new RenderClayCamHandler();
        MinecraftForge.EVENT_BUS.register((Object)clayCamHandler);
        FMLCommonHandler.instance().bus().register((Object)clayCamHandler);
    }

    @Override
    public void switchClayCam(boolean enable, EntityClayMan clayMan) {
        s_clayCamEntity = enable ? clayMan : null;
    }
    ...
    public void applySoldierRenderFlags(int entityId, long upgFlags1, long upgFlags2, long effFlags1, long effFlags2) {
        ...
        Entity entity = ((World)world).getEntityByID(entityId);
