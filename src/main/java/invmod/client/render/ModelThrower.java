...
public class ModelThrower extends ModelBase
{
  ...
  public ModelThrower(float f, float f1)
  {
    ...
    this.bipedHead.setRotationPoint(0.5F, 16.0F, 0.5F);
    this.bipedHead.rotateAngleX = 0.0F;
    this.bipedHead.rotateAngleY = 0.0F;
    this.bipedHead.rotateAngleZ = 0.0F;
    this.bipedHead.mirror = false;
    this.bipedBody = new ModelRenderer(this, 0, 1);
    this.bipedBody.addBox(-7.0F, 2.0F, -4.0F, 14, 4, 9, 0.0F);
    this.bipedBody.setRotationPoint(0.5F, 16.0F, -0.5F);
    ...
    this.bipedRightArm.setRotationPoint(-5.5F, 16.0F, 1.5F);
    ...
    this.bipedLeftArm.setRotationPoint(6.5F, 16.0F, 1.5F);
    ...
    this.bipedRightLeg.setRotationPoint(-2.5F, 22.0F, 0.5F);
    ...
    this.bipedLeftLeg.setRotationPoint(3.5F, 22.0F, 0.5F);
    this.bipedLeftLeg.rotateAngleX = 0.0F;
    this.bipedLeftLeg.rotateAngleY = 0.0F;
    this.bipedLeftLeg.rotateAngleZ = 0.0F;
    this.bipedLeftLeg.mirror = false;
    this.bipedBody2 = new ModelRenderer(this, 0, 23);
    this.bipedBody2.addBox(-6.0F, 0.0F, 0.0F, 12, 2, 7, 0.0F);
    this.bipedBody2.setRotationPoint(0.5F, 16.0F, -3.5F);
