...
public class ItemPouch extends ItemEquippable implements IBaubleExpanded, IBauble {
   ...
   public void onEquipped(ItemStack stack, EntityLivingBase player) {
       if(player instanceof EntityPlayer) {
           EntityPropertiesSatchels.fromPlayer((EntityPlayer)player).updateInventories(stack);
       }
   }
