...
import gravestone.core.recipe.SwordGravestoneRecipe;
...
public class GSRecipes {
   ...
   public static void registration() {
      ...
      GameRegistry.addRecipe(new ShapedOreRecipe(getStackWithNTB(GSBlock.memorial, (byte)EnumMemorials.GIBBET.ordinal(), "GraveType"), "ww ", "wr ", "wc ", 'w', Blocks.planks, 'r', Items.lead, 'c', GSChiselRegistry.ORE_NAME));
      GameRegistry.addRecipe(new ShapedOreRecipe(getStackWithNTB(GSBlock.memorial, (byte)EnumMemorials.STOCKS.ordinal(), "GraveType"), "wsw", "wcw", 'w', Blocks.planks, 's', Blocks.wooden_slab, 'c', GSChiselRegistry.ORE_NAME));
      ...
      if (GraveStoneConfig.enableBossSpawnerCraftingRecipe) {
         GameRegistry.addRecipe(new ItemStack(GSBlock.spawner, 1, EnumSpawner.WITHER_SPAWNER.ordinal()), "bcb", "cec", "cbc", 'c', new ItemStack(GSBlock.skullCandle, 1, EnumSkullCandle.WITHER_SKULL.ordinal()), 'b', new ItemStack(Items.dye, 1, 15), 'e', Items.ender_eye);
      }

      if (GraveStoneConfig.enableSpawnerCraftingRecipe) {
         GameRegistry.addRecipe(new ItemStack(GSBlock.spawner, 1, EnumSpawner.SKELETON_SPAWNER.ordinal()), "bcb", "cec", "cbc", 'c', new ItemStack(GSBlock.skullCandle, 1, EnumSkullCandle.SKELETON_SKULL.ordinal()), 'b', new ItemStack(Items.dye, 1, 15), 'e', Items.ender_eye);
         GameRegistry.addRecipe(new ItemStack(GSBlock.spawner, 1, EnumSpawner.ZOMBIE_SPAWNER.ordinal()), "bcb", "cec", "cbc", 'c', new ItemStack(GSBlock.skullCandle, 1, EnumSkullCandle.ZOMBIE_SKULL.ordinal()), 'b', new ItemStack(Items.dye, 1, 15), 'e', Items.ender_eye);
      }
      ...
      GameRegistry.addRecipe(new ItemStack(GSBlock.altar), " h ", "sns", "bbb", 'h', altarCrystal, 's', new ItemStack(Items.skull, 1, 0), 'n', new ItemStack(GSBlock.trap, 1, 0), 'b', new ItemStack(GSBlock.boneBlock, 1, 0));
   }

   public static void registerSwordGravestoneRecipes() {
      Set<Item> swords = new LinkedHashSet<Item>();
      for (Item configuredSword : GraveStoneHelper.swordsList) {
         if (configuredSword instanceof ItemSword) {
            swords.add(configuredSword);
         }
      }
      for(Object registered : Item.itemRegistry) {
         if (registered instanceof ItemSword) {
            swords.add((Item)registered);
         }
      }
      for(Item sword : swords) {
         if (!GraveStoneHelper.swordsList.contains(sword)) {
            GraveStoneHelper.swordsList.add(sword);
         }
         GameRegistry.addRecipe(new SwordGravestoneRecipe(sword));
      }
   }
   ...
   private static void addVerticalPlateGravestoneRecipe(ItemStack gravestone, Block material) {
      GameRegistry.addRecipe(new ShapedOreRecipe(gravestone, "mc", 'm', material, 'c', GSChiselRegistry.ORE_NAME));
   }

   private static void addCrossGravestoneRecipe(ItemStack gravestone, Block material) {
      GameRegistry.addRecipe(new ShapedOreRecipe(gravestone, " c", "m ", 'm', material, 'c', GSChiselRegistry.ORE_NAME));
   }
   ...
   private static void addCrossMemorialRecipe(ItemStack memorial, Block material) {
      GameRegistry.addRecipe(new ShapedOreRecipe(memorial, " mc", "mmm", " m ", 'm', material, 'c', GSChiselRegistry.ORE_NAME));
   }

   private static void addObeliskMemorialRecipe(ItemStack memorial, Block material) {
      GameRegistry.addRecipe(new ShapedOreRecipe(memorial, " mc", " m ", "mmm", 'm', material, 'c', GSChiselRegistry.ORE_NAME));
   }

   private static void addSteveMemorialRecipe(ItemStack memorial, Block material) {
      GameRegistry.addRecipe(new ShapedOreRecipe(memorial, "mc", "m ", "m ", 'm', material, 'c', GSChiselRegistry.ORE_NAME));
   }

   private static void addVillagerMemorialRecipe(ItemStack memorial, Block material) {
      GameRegistry.addRecipe(new ShapedOreRecipe(memorial, "m ", "mc", "m ", 'm', material, 'c', GSChiselRegistry.ORE_NAME));
   }

   private static void addAngelMemorialRecipe(ItemStack memorial, Block material) {
      GameRegistry.addRecipe(new ShapedOreRecipe(memorial, "m ", "m ", "mc", 'm', material, 'c', GSChiselRegistry.ORE_NAME));
   }

   private static void addDogMemorialRecipe(ItemStack memorial, Block material) {
      GameRegistry.addRecipe(new ShapedOreRecipe(memorial, "mc", "m ", 'm', material, 'c', GSChiselRegistry.ORE_NAME));
   }

   private static void addCatMemorialRecipe(ItemStack memorial, Block material) {
      GameRegistry.addRecipe(new ShapedOreRecipe(memorial, "m ", "mc", 'm', material, 'c', GSChiselRegistry.ORE_NAME));
   }

   private static void addCreeperMemorialRecipe(ItemStack memorial, Block material) {
      GameRegistry.addRecipe(new ShapedOreRecipe(memorial, "m  ", "m c", "m  ", 'm', material, 'c', GSChiselRegistry.ORE_NAME));
   }
