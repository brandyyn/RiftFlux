...
public class ModelCatStatueMemorial extends ModelMemorial {
   ...
   public void setRotationAngles(float par1, float par2, float par4, float par5) {
      ...
      this.ocelotBody.rotationPointY = 8.0F;
      this.ocelotBody.rotationPointZ = -5.0F;
      this.ocelotHead.rotationPointY = 11.7F;
      this.ocelotHead.rotationPointZ = -8.0F;
      this.ocelotTail.rotationPointY = 23.0F;
      this.ocelotTail.rotationPointZ = 6.0F;
      this.ocelotTail2.rotationPointY = 22.0F;
