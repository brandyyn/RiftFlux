...
public class ScrollScythewind
extends SpellItem {
    public ScrollScythewind() {
        this.baseArcanePower = 6.0;
        this.setUnlocalizedName("scythewindScroll");
        this.setTextureName("legendgear:scroll");
        this.setMaxDamage(0);
        this.setMaxStackSize(16);
        this.baseStaminaCost = 6.0f;
        this.baseMeleeDamage = 0;
        this.spellType = EntitySpellEffect.SpellType.ScytheWind;
